...
export default function LeftContactContent () {
    return (
        ...
        <p className={`${styles['']} main-txt-font`}>Die Idee dieser Seite ist, alle Infos bezüglich dem Schuljahr und unserer Schule auf einer Seite zu haben. Kein lästiges Zettel suchen oder ständinges nachfragen mehr.</p>
        <p className={`${styles['']} main-txt-font`}>Alle Infos auf einen Blick, immer und überall, auch am Smartphone.</p>
